...
namespace MVC5.Controllers
{
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(LoginViewModel viewModel)
        {
            ...
            {
                int id = 0;
                var user = db.Users.Where(b => b.EmailAddress == viewModel.EmailAddress & b.PassWord == viewModel.PassWord);
                if (user.Count() > 0)
                {
                ...
                {
                    ModelState.AddModelError("IdentityError", "用户名或密码错误");
        ...
        public ActionResult Register(RegisterViewModel viewModel)
        {
            if (ModelState.IsValid)
            {
                ...
                userModel.EmailAddress = viewModel.EmailAddress;
